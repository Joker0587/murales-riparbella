    ...
    <div className="app">
      ...
      <footer>
        ...
        <div className="support-box">
          <p><strong>Questa guida è gratuita.</strong></p>
          <p>Se vuoi contribuire ai costi tecnici e allo sviluppo del progetto, puoi offrire un caffè.</p>
          <a href="https://ko-fi.com/francescobolognesi" target="_blank" rel="noreferrer">Sostieni su Ko-fi</a>
        </div>
        <p>Testi, immagini e opere appartengono ai rispettivi autori e aventi diritto.</p>
        <p><strong>Versione prototipo — 1.30</strong></p>
      </footer>
    </div>
  );
}
